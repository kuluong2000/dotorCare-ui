...
//import image
import avatar from "../../assets/images/service/doctor1.png";
    ...
    <main>
      <section className={cx("banner")}>
        ...
        <div>
          ...
          <Image className={cx("banner-image-mb")} src={require("../../assets/images/service/doctor-list-banner-mb.png")}></Image>
        </div>
      </section>
      ...
      <section className={cx("care")}>
        <div className={cx("care-bg")}>
          <Image src={require("../../assets/images/service/elite-care-bg.svg").default} alt="" />
        </div>
        <div className="container">
          <div className="row">
              ...
              <div className={cx("care-info")}>
                <div className="row">
                  <div className="col-md-6 col-12">
                    <div className={cx("care-info-item")}>
                      <div className={cx("care-info-item-media")}>
                        <Image src={require("../../assets/images/service/experience.png")}></Image>
                      </div>
                  ...
                  <div className="col-md-6 col-12">
                    <div className={cx("care-info-item")}>
                      <div className={cx("care-info-item-media")}>
                        <Image src={require("../../assets/images/service/distinguished.png")}></Image>
                      </div>
                      <div className={cx("care-info-item-body")}>
                  ...
                  <div className="col-md-6 col-12">
                    <div className={cx("care-info-item")}>
                      <div className={cx("care-info-item-media")}>
                        <Image src={require("../../assets/images/service/international.png")}></Image>
                      </div>
                      <div className={cx("care-info-item-body")}>
                  ...
                  <div className="col-md-6 col-12">
                    <div className={cx("care-info-item")}>
                      <div className={cx("care-info-item-media")}>
                        <Image src={require("../../assets/images/service/multilingual.png")}></Image>
                      </div>
                      <div className={cx("care-info-item-body")}>
                ...
                <div className={cx("block-list-content-slider")}>
                  <Slider {...blockSlider}>
                    <div className={cx("block-list-item")}>
                      <Image src={require("../../assets/images/service/block-list-img1.png")}></Image>
                    ...
                    <div className={cx("block-list-item")}>
                      <Image src={require("../../assets/images/service/block-list-img2.png")}></Image>
                      <div className={cx("block-list-item-content")}>
                        <div className={cx("block-list-item-time")}>
                    ...
                    <div className={cx("block-list-item")}>
                      <Image src={require("../../assets/images/service/block-list-img3.png")}></Image>
                      <div className={cx("block-list-item-content")}>
                        <div className={cx("block-list-item-time")}>
                    ...
                    <div className={cx("block-list-item")}>
                      <Image src={require("../../assets/images/service/block-list-img4.jpg")}></Image>
                      <div className={cx("block-list-item-content")}>
                        <div className={cx("block-list-item-time")}>
                          <Link to="/">Nhi khoa</Link>
                          <span> 22 tháng 6, 2021</span>
